...
## 2026-04-05 - Enhance empty states with helpful guidance
**Learning:** Empty states (like when a model hasn't been trained yet) can be confusing. Simply telling the user to "use the controls on the left" is less effective than providing a clear, numbered "Getting Started" guide right where the content will appear.
**Action:** Always include actionable, step-by-step guidance in empty states to orient the user and reduce cognitive load.
